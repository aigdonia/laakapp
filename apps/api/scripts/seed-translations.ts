...
const en = {
  ...
  insights: {
    ...
    deep_analysis: 'Deep Portfolio Analysis',
    deep_analysis_description: 'Uncover what your charts can\'t show — performance drivers, risks, and compliance insights across your entire portfolio.',
    unlock_deep_analysis: 'Unlock Deep Analysis',
    stock_analysis: 'AI Analysis',
    stock_analysis_description: 'Understand what you own — financial health, compliance breakdown, and what stands out about this holding.',
...
const ar: Record<string, Record<string, string>> = {
  ...
  insights: {
    ...
    deep_analysis: 'تحليل المحفظة المعمّق',
    deep_analysis_description: 'اكتشف ما لا تُظهره الرسوم البيانية — محركات الأداء والمخاطر ورؤى التوافق عبر محفظتك بالكامل.',
    unlock_deep_analysis: 'فتح التحليل المعمّق',
    stock_analysis: 'تحليل ذكي',
    stock_analysis_description: 'افهم ما تملك — الصحة المالية وتفاصيل التوافق وما يميّز هذا الاستثمار.',
    unlock_stock_analysis: 'فتح التحليل الذكي',
    new_analysis_available: 'تحليل جديد متاح. اضغط للتحديث.',
    generating_narrative: 'جارٍ إنشاء التقرير...',
    tap_to_read_more: 'اضغط لقراءة المزيد',
    regenerate: 'إعادة التوليد',
    narrative_refresh: 'تغيّرت المحفظة. اضغط للتحديث.',
    insufficient_credits: 'رصيد غير كافٍ',
    insufficient_credits_message: 'هذه الميزة تتطلب {{count}} رصيد. اشترِ المزيد للمتابعة.',
