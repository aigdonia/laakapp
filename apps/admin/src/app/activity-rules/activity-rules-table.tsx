              ...
              <tr key={rule.id} className="border-b last:border-0">
                <td className="px-4 py-3">
                  <button type="button" className="text-start" onClick={() => openEdit(rule)}>
                    <div className="font-medium hover:underline">{rule.name}</div>
                  </button>
                </td>
                <td className="px-4 py-3">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Rule triggers when user reaches this event count.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="rounded-lg border p-3 space-y-3">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input
              ...
              placeholder="+2 LAK for your 3rd holding!"
            />
          </div>
        </div>
      )
        ...
        <div className="rounded-lg border p-3 space-y-3">
          <div className="flex flex-col gap-2">
            ...
            <Input
              ...
              placeholder={actionType === "show_confetti" ? "Milestone!" : "Nice!"}
            />
          </div>
          <div className="flex flex-col gap-2">
            <Label htmlFor="message">Message</Label>
